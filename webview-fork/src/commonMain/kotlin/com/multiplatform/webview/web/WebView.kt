...
// WAVORA FORK: la declaración `expect fun ActualWebView(...)` que estaba
// acá se sacó — este módulo es Kotlin/JVM plano (un solo target), la
// única implementación es la de WebView.desktop.kt (ahora sin `actual`).

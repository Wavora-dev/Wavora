...
interface IWebView {
     ...
     */
    // WAVORA FORK: ver nota equivalente en WebView.desktop.kt — la 1.8.4
    // original usaba org.jetbrains.compose.resources.resource(...), que ya
    // no existe en la versión de Compose Multiplatform de este proyecto.
    // Este módulo es un solo target (JVM), así que se lee directo del
    // classpath.

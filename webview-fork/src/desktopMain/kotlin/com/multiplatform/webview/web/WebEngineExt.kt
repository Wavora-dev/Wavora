...
internal fun CefBrowser.addDisplayHandler(state: WebViewState) {
    this.client.addDisplayHandler(
        object : CefDisplayHandler {
            ...
            // WAVORA FORK: método agregado a la interfaz CefDisplayHandler en
            // una versión de jcef posterior a la que usaba originalmente la
            // 1.8.4 (confirmado: el jcef vendorizado por el KCEF 2024.04.20.4
            // que este proyecto fuerza ya lo declara como abstracto). Sin
            // este override, `object : CefDisplayHandler { ... }` no compila
            // porque queda un miembro abstracto sin implementar. No-op: no
            // necesitamos reaccionar a cambios de fullscreen para el WebView
            // de login.

...
fun Thumbnail.toThumbnail(): com.wavora.domain.model.model.searchResult.songs.Thumbnail =
    com.wavora.domain.model.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.wavora.domain.model.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.wavora.domain.model.model.searchResult.songs.Thumbnail>()
    this.forEach {

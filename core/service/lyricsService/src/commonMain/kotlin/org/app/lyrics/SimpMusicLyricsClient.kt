...
import com.wavora.ktorext.crypto.Hmac
import com.wavora.ktorext.crypto.HmacUri
...
import com.wavora.lyrics.models.response.BaseResponse
...
private const val TAG = "WavoraLyricsClient"

class WavoraLyricsClient {
    private val algorithm = ""

    private val hmacService = Hmac("HmacSHA256", "wavora-lyrics")
    private val lyricsService = WavoraLyrics()

...
import com.wavora.lyrics.models.request.VoteBody
...
class WavoraLyrics {
    ...
    private val baseUrl = "https://api-lyrics.wavora.org/v1/"
    ...
    private fun createClient() =
        HttpClient(getEngine()) {
            ...
            defaultRequest {
                url("https://api-lyrics.wavora.org/v1")
            }
            if (proxy != null) {
                engine {
                    proxy = this@WavoraLyrics.proxy
                }
            }
        }
    ...
    private fun HttpRequestBuilder.buildDefaultHeaders(
        ...
        headers {
            ...
            header(HttpHeaders.UserAgent, "WavoraLyrics/1.0")

...
actual class Extractor {
    ...
    actual fun mergeAudioVideoDownload(filePath: String): DownloadProgress {
        ...
        if (FileSystem.SYSTEM.exists("$filePath-Wavora.mp4".toPath())) {
            FileSystem.SYSTEM.delete("$filePath-Wavora.mp4".toPath())
        }
    ...
    actual fun saveAudioWithThumbnail(
        ...
        try {
            ...
            if (FileSystem.SYSTEM.exists("$filePath-wavora.mp3".toPath())) {
                FileSystem.SYSTEM.delete("$filePath-wavora.mp3".toPath())
            }
        } catch (e: IOException) {
            e.printStackTrace()
        }

...
import com.wavora.scraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import com.wavora.scraper.extension.toListFormat
...
import com.wavora.scraper.models.GridRenderer
import com.wavora.scraper.models.MediaType
...
import com.wavora.scraper.models.ReturnYouTubeDislikeResponse
import com.wavora.scraper.models.Run
import com.wavora.scraper.models.SearchSuggestions
import com.wavora.scraper.models.SongInfo
import com.wavora.scraper.models.SongItem
import com.wavora.scraper.models.TidalMetadataResult
import com.wavora.scraper.models.VideoItem
import com.wavora.scraper.models.WatchEndpoint
import com.wavora.scraper.models.YTItemType
import com.wavora.scraper.models.YouTubeClient
import com.wavora.scraper.models.YouTubeClient.Companion.TVHTML5
import com.wavora.scraper.models.YouTubeClient.Companion.WEB
import com.wavora.scraper.models.YouTubeClient.Companion.WEB_REMIX
import com.wavora.scraper.models.YouTubeLocale
import com.wavora.scraper.models.getContinuation
import com.wavora.scraper.models.oddElements
import com.wavora.scraper.models.response.AccountMenuResponse
import com.wavora.scraper.models.response.AccountSwitcherEndpointResponse
import com.wavora.scraper.models.response.AddItemYouTubePlaylistResponse
import com.wavora.scraper.models.response.BrowseResponse
import com.wavora.scraper.models.response.CreatePlaylistResponse
import com.wavora.scraper.models.response.DownloadProgress
import com.wavora.scraper.models.response.GetQueueResponse
import com.wavora.scraper.models.response.GetSearchSuggestionsResponse
import com.wavora.scraper.models.response.LikeStatus
import com.wavora.scraper.models.response.NextAndroidMusicResponse
import com.wavora.scraper.models.response.NextResponse
import com.wavora.scraper.models.response.PipedResponse
import com.wavora.scraper.models.response.PlayerResponse
import com.wavora.scraper.models.response.SearchResponse
import com.wavora.scraper.models.response.WavoraChartResponse
import com.wavora.scraper.models.response.TidalSearchResponse
import com.wavora.scraper.models.response.TidalOAuthResponse
import com.wavora.scraper.models.response.RemoteConfig
import com.wavora.scraper.models.response.toLikeStatus
import com.wavora.scraper.models.response.toListAccountInfo
import com.wavora.scraper.models.wavora.FdroidResponse
import com.wavora.scraper.models.wavora.GithubResponse
import com.wavora.scraper.models.sponsorblock.SkipSegments
import com.wavora.scraper.models.youtube.GhostResponse
import com.wavora.scraper.models.youtube.Transcript
import com.wavora.scraper.models.youtube.YouTubeInitialPage
import com.wavora.scraper.models.youtube.tryDecodeText
import com.wavora.scraper.pages.AlbumPage
import com.wavora.scraper.pages.ArtistPage
import com.wavora.scraper.pages.ArtistSection
import com.wavora.scraper.pages.BrowseResult
import com.wavora.scraper.pages.ExplorePage
import com.wavora.scraper.pages.MoodAndGenres
import com.wavora.scraper.pages.NextPage
import com.wavora.scraper.pages.NextResult
import com.wavora.scraper.pages.PlaylistContinuationPage
import com.wavora.scraper.pages.PlaylistPage
import com.wavora.scraper.pages.RelatedPage
import com.wavora.scraper.pages.SearchPage
import com.wavora.scraper.pages.SearchResult
import com.wavora.scraper.pages.SearchSuggestionPage
import com.wavora.scraper.parser.fromPlaylistContinuationToTracks
import com.wavora.scraper.parser.fromPlaylistToTrack
import com.wavora.scraper.parser.fromPlaylistToTrackWithSetVideoId
import com.wavora.scraper.parser.getContinuePlaylistContinuation
import com.wavora.scraper.parser.getPlaylistContinuation
import com.wavora.scraper.parser.getReloadParams
import com.wavora.scraper.parser.getSuggestionSongItems
import com.wavora.scraper.parser.hasReloadParams
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with Wavora
 *
 * Here is the object that can create all request to YouTube Music and Spotify in Wavora
...
class YouTube {
     ...
     * In Wavora, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function

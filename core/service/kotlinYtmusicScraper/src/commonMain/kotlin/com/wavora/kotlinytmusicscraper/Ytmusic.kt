...
import com.wavora.scraper.extractor.Extractor
...
import com.wavora.scraper.models.YouTubeClient.Companion.IOS
...
import com.wavora.scraper.models.body.AccountMenuBody
import com.wavora.scraper.models.body.BrowseBody
import com.wavora.scraper.models.body.CreatePlaylistBody
import com.wavora.scraper.models.body.EditPlaylistBody
import com.wavora.scraper.models.body.FormData
import com.wavora.scraper.models.body.GetQueueBody
import com.wavora.scraper.models.body.GetSearchSuggestionsBody
import com.wavora.scraper.models.body.LikeBody
import com.wavora.scraper.models.body.NextBody
import com.wavora.scraper.models.body.PlayerBody
import com.wavora.scraper.models.body.SearchBody
import com.wavora.scraper.models.response.DownloadProgress
import com.wavora.scraper.models.response.RemoteConfig
import com.wavora.scraper.utils.parseCookieString
import com.wavora.scraper.utils.sha1
import com.wavora.ktorext.curl.CurlLogger
...
//                    },
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/wavora-dev/Wavora/releases/latest") {
            contentType(ContentType.Application.Json)
        }

    suspend fun checkForFdroidUpdate() =
        httpClient.get("https://f-droid.org/api/v1/packages/com.wavora.app") {
            contentType(ContentType.Application.Json)
        }

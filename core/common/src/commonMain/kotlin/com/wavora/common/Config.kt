...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "Wavora Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "Wavora Playback Notification ID"
}
